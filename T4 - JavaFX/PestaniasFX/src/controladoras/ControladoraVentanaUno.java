...
public class ControladoraVentanaUno implements Initializable {
    ...
    @FXML
    Button btnNormal, btnImagen, botonPantalla, btnListView;
    ...
    private void personalizarLista() {
        ...
        listaElementos.addAll(new Persona("Adrian ", "Olmo"));
    }
    ...
    private void acciones() {
        ...
        btnListView.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                Persona personaLista = (Persona) listview.getSelectionModel().getSelectedItem();
